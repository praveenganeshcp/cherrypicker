...
import { authorizeGithubAccountAction, errorInAuthorizingGithubAccountAction, githubAccountAuthorizedAction } from '../store/actions';
...
export class OauthCallbackComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    this.actionsDispatcher.dispatchAsyncAction(
      authorizeGithubAccountAction({exchangeCode: this.activatedRoute.snapshot.queryParams['code']}),
